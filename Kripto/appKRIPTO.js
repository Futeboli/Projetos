...
function kripto() {
    ...
    /*CODIGO CRIPTOGRAFANDO*/let kript = krip.replace(/e/g,"enter").replace(/i/g,"imes").replace(/a/g,"ai").replace(/o/g,"ober").replace(/u/g,"ufat").replace(/E/g,"ENTER").replace(/I/g,"IMES").replace(/A/g,"AI").replace(/O/g,"OBER").replace(/U/g,"UFAT");
...
function deskripto() {
    ...
    /*CODIGO DESCRIPTOGRAFANDO*/let deskript = deskrip.replace(/enter/g,"e").replace(/imes/g,"i").replace(/ai/g,"a").replace(/ober/g,"o").replace(/ufat/g,"u").replace(/ENTER/g,"E").replace(/IMES/g,"I").replace(/AI/g,"A").replace(/OBER/g,"O").replace(/UFAT/g,"U");
